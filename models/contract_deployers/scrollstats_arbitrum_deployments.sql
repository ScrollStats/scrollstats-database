...
FROM ARBITRUM.RAW.TRACES rt
INNER JOIN ARBITRUM.RAW.CONTRACTS rc 
...
CASE WHEN cc.ADDRESS IS NOT NULL 
    THEN 1 ELSE 0 
    END AS IS_USED
FROM ARBITRUM.RAW.CONTRACTS src
LEFT JOIN CALLED_CONTRACTS cc
    ON src.ADDRESS = cc.ADDRESS
LEFT JOIN ARBITRUM.RAW.ERC20_TOKENS erc20
    ON src.ADDRESS = erc20.ADDRESS 
LEFT JOIN ARBITRUM.RAW.ERC1155_TOKENS erc1155
    ON src.ADDRESS = erc1155.ADDRESS 
LEFT JOIN ARBITRUM.RAW.ERC721_TOKENS erc721
