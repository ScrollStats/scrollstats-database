...
FROM OPTIMISM.RAW.TRACES rt
INNER JOIN OPTIMISM.RAW.CONTRACTS rc 
...
CASE WHEN cc.ADDRESS IS NOT NULL 
    THEN 1 ELSE 0 
    END AS IS_USED
FROM OPTIMISM.RAW.CONTRACTS src
LEFT JOIN CALLED_CONTRACTS cc
    ON src.ADDRESS = cc.ADDRESS
LEFT JOIN OPTIMISM.RAW.ERC20_TOKENS erc20
    ON src.ADDRESS = erc20.ADDRESS 
LEFT JOIN OPTIMISM.RAW.ERC1155_TOKENS erc1155
    ON src.ADDRESS = erc1155.ADDRESS 
LEFT JOIN OPTIMISM.RAW.ERC721_TOKENS erc721
